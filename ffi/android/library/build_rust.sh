...
aarch64-linux-android21-clang++ -fPIC -shared swig_wrap.cxx -L../../../target/aarch64-linux-android/debug/ -lrgb -o library/src/main/jniLibs/arm64-v8a/librgb_node.so
...
x86_64-linux-android21-clang++ -fPIC -shared swig_wrap.cxx -L../../../target/x86_64-linux-android/debug/ -lrgb -o library/src/main/jniLibs/x86_64/librgb_node.so
...
armv7a-linux-androideabi21-clang++ -fPIC -shared swig_wrap.cxx -L../../../target/armv7-linux-androideabi/debug/ -lrgb -o library/src/main/jniLibs/armeabi-v7a/librgb_node.so
...
i686-linux-android21-clang++ -fPIC -shared swig_wrap.cxx -L../../../target/i686-linux-android/debug/ -lrgb -o library/src/main/jniLibs/x86/librgb_node.so
